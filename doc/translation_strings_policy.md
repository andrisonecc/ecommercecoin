...
This document provides guidelines for internationalization of the Ecommercecoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `ecommercecoin_en.ts` remains unchanged.
