...
# TestP2PConn: A peer we use to send messages to ecommercecoind, and store responses.
...
class CompactBlocksTest(EcommercecoinTestFramework):
    ...
    # This test actually causes ecommercecoind to (reasonably!) disconnect us, so do this last.
    ...
    # ecommercecoind's choice of nonce.
    ...
    # Test that ecommercecoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for ecommercecoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # ecommercecoind will not send blocktxn responses for blocks whose height is
