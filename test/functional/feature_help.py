...
"""Verify that starting ecommercecoin with -h works as expected."""

from test_framework.test_framework import EcommercecoinTestFramework
from test_framework.util import assert_equal

class HelpTest(EcommercecoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start ecommercecoin with -h for help text")
        ...
        self.log.info("Start ecommercecoin with -version for version information")
        ...
        self.log.info("Start ecommercecoind with -fakearg to make sure it does not start")
