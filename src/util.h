 ...
 */
#ifndef ECOMMERCECOIN_UTIL_H
#define ECOMMERCECOIN_UTIL_H
...
extern const char * const ECOMMERCECOIN_CONF_FILENAME;
extern const char * const ECOMMERCECOIN_PID_FILENAME;
...
{
    std::string s = strprintf("ecommercecoin-%s", name);
