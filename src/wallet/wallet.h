...
#ifndef ECOMMERCECOIN_WALLET_WALLET_H
#define ECOMMERCECOIN_WALLET_WALLET_H
...
public:
     ...
     * on this ecommercecoin node, and set to 0 for transactions that were created
...
#endif // ECOMMERCECOIN_WALLET_WALLET_H
