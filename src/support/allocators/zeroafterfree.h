...
#ifndef ECOMMERCECOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
#define ECOMMERCECOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
...
#endif // ECOMMERCECOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
