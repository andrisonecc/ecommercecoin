    ...
    mapper(0)
{
    ...
    ui->ecommercecoinAtStartup->setToolTip(ui->ecommercecoinAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->ecommercecoinAtStartup->setText(ui->ecommercecoinAtStartup->text().arg(tr(PACKAGE_NAME)));

    ui->openEcommercecoinConfButton->setToolTip(ui->openEcommercecoinConfButton->toolTip().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new EcommercecoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->ecommercecoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openEcommercecoinConfButton_clicked()
{
    ...
    if (!GUIUtil::openEcommercecoinConf())
