...
#ifndef ECOMMERCECOIN_QT_SENDCOINSDIALOG_H
#define ECOMMERCECOIN_QT_SENDCOINSDIALOG_H
...
/** Dialog for sending ecommercecoins */
...
#endif // ECOMMERCECOIN_QT_SENDCOINSDIALOG_H
