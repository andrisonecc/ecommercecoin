...
#ifndef ECOMMERCECOIN_INTERFACES_NODE_H
#define ECOMMERCECOIN_INTERFACES_NODE_H
...
//! Top-level interface for a ecommercecoin node (ecommercecoind process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // ECOMMERCECOIN_INTERFACES_NODE_H
