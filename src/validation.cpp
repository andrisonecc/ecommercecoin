...
#if defined(NDEBUG)
# error "Ecommercecoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Ecommercecoin Signed Message:\n";
...
void ThreadScriptCheck() {
    RenameThread("ecommercecoin-scriptch");
