...
#ifndef ECOMMERCECOIN_TEST_SCRIPTNUM10_H
#define ECOMMERCECOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Ecommercecoin Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // ECOMMERCECOIN_TEST_BIGNUM_H
