...
{
    BOOST_CHECK(TestSplitHost("www.ecommercecoincore.org", "www.ecommercecoincore.org", -1));
    BOOST_CHECK(TestSplitHost("[www.ecommercecoincore.org]", "www.ecommercecoincore.org", -1));
    BOOST_CHECK(TestSplitHost("www.ecommercecoincore.org:80", "www.ecommercecoincore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.ecommercecoincore.org]:80", "www.ecommercecoincore.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:5770", "127.0.0.1", 5770));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:5770", "127.0.0.1", 5770));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:5770", "::ffff:127.0.0.1", 5770));
    BOOST_CHECK(TestSplitHost("[::]:5770", "::", 5770));
    BOOST_CHECK(TestSplitHost("::5770", "::5770", -1));
    BOOST_CHECK(TestSplitHost(":5770", "", 5770));
    BOOST_CHECK(TestSplitHost("[]:5770", "", 5770));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:5770", "127.0.0.1:5770"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:5770", "[::]:5770"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
