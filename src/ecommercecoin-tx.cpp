...
static void SetupEcommercecoinTxArgs()
{
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " ecommercecoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  ecommercecoin-tx [options] <hex-tx> [commands]  Update hex-encoded ecommercecoin transaction\n" +
            "or:     ecommercecoin-tx [options] -create [commands]   Create hex-encoded ecommercecoin transaction\n" +
            "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded ecommercecoin transaction
